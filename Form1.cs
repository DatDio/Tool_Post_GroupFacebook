...
namespace Tool_Facebook
{
	public partial class Form1 : Form
	{
		...
		{
			OpenChildForm(new ManagePageForm());
		}
		#region datagrid =""
		...
		#endregion
		private void btnOpenProxy_Click_1(object sender, EventArgs e)
		{
			Process.Start(Path.GetFullPath("input/Proxy.txt"));
		}

		private void btnOpenContent_Click_1(object sender, EventArgs e)
		{
			Process.Start(Path.GetFullPath("input/ListContent.txt"));
		}
		private void btnOpenLinkVideo_Click_1(object sender, EventArgs e)
		{
		...
		private void btnAddFolderAcc_Click_1(object sender, EventArgs e)
		{
			FolderManageAccForm folderManageAccForm = new FolderManageAccForm("Account");
			folderManageAccForm.ShowDialog();
			//sqlController.createTable($"INSERT INTO tbl_topic(C_Topic) VALUES ()");
		...
		private void btnDeleteFolderGroup_Click_1(object sender, EventArgs e)
		{
